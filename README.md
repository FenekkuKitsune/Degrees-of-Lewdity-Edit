...
It probably doesn't need to be said, but just in case it does: This script DOES NOT SUPPORT MODS! If you're running a modded version of the game you're using this script at your own risk! If it's asked for I can add versions of this script that will work with mods, but for now only the vanilla version of the game is supported!
